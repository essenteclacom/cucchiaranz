...
<head>
    ...
    <title>CUCCHIARA - Iniciar Sesión</title>
</head>
<body>
            ...
            <div class="flex flex-col">
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-row justify-end">
                        <div class="px-2">
                            <a class="font-body text-color-cucchiara flex items-center justify-center rounded-md bg-white button-border-color xxs:text-xs xxs:px-1 xs:px-5 sm:px-8 md:px-8 lg:px-8 xxs:py-2 xs:py-2 sm:py-2 md:py-2 lg:py-2 xl:py-2 xs:text-base lg:text-base font-bold hover:bg-cyan-20">Sign in</a>
                        </div>
                        <div class="px-2">
                            <a href="/seleccionartipocuenta" class="font-body text-color-cucchiara flex items-center justify-center rounded-md bg-white button-border-color xxs:text-xs xxs:px-1 xs:px-5 sm:px-8 md:px-8 lg:px-8 xxs:py-2 xs:py-2 sm:py-2 md:py-2 lg:py-2 xl:py-2 xs:text-base lg:text-base font-bold hover:bg-cyan-20">Sign up</a>
                        </div>
                    </div>
                </div>
            </div>
